...
let ru_1970_m = [
		{
			...
			group : 'Олег Даль',
			song : 'Мальчик Купидон (к/ф «Не может быть») (1975)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Лев Лещенко',
			song : 'Соловьиная роща (1976)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Лев Лещенко',
		...
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Лев Лещенко',
			song : 'Всё от тебя (1974)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Иосиф Кобзон',
			song : 'Где-то далеко (к/ф «Семнадцать мгновений весны») (1973)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Иосиф Кобзон',
			song : 'Мгновения (к/ф «Семнадцать мгновений весны») (1973)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Муслим Магомаев',
			song : 'Луч солнца золотого (1973)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Муслим Магомаев',
			song : 'Ты моя мелодия (1973)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Муслим Магомаев',
			song : 'Чёртово колесо (1970)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Эдуард Хиль',
		...
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Олег Анофриев',
			song : 'Есть только миг (Из к/ф «Земля Санникова») (1973)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Валерий Золотухин',
			song : 'Разговор со счастьем (Из к/ф «Иван Васильевич меняет профессию») (1973)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Александр Градский',
			song : 'Как молоды мы были (1976)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Александр Градский',
			song : 'Песня о корабле (Из к/ф «Свой среди чужих, чужой среди своих») (1975)'
		},
		{
			pack : RU_1970_M_PACK_1,
			group : 'Кола Бельды',
			song : 'Увезу тебя я в тундру (1971)'
		}
];
